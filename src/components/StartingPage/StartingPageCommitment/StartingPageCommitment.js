...
const StartingPageCommitment = () => {
  return (
    <div className="starting__Commitment">
      <h3>Nos engagements</h3>
      <p>
        Des blés 100% canadien pour la farine de nos produits. C’est l’un de nos
        engagements pris depuis les débuts !
      </p>
      <h5>DES PRODUITS DE QUALITÉ</h5>
      <p>
        La boulangerie est soumise de façon régulière à des contrôles sur la
        qualité de ses produits qui s’effectuent dans des laboratoires canadiens
        agréés.{" "}
      </p>
      <p>
...
export default StartingPageCommitment;
